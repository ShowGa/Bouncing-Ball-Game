...
function drawBall() {
  ...
  if (
    ...
    // change ball forward movement angle
    if (ball_x > ground_x + 20 && ball_x < ground_x + 40) {
      speed_x = 0;
      if (speed_y === 4 || speed_y === -4) {
        speed_y = (speed_y * 3) / 2;
      }
    } else if (ball_x < ground_x + 20) {
      speed_x = -4;
      if (speed_y === 6 || speed_y === -6) {
        speed_y = (speed_y * 2) / 3;
      }
    } else if (ball_x > ground_x + 40) {
      speed_x = 4;
      if (speed_y === 6 || speed_y === -6) {
        speed_y = (speed_y * 2) / 3;
      }
  ...
  if (
    ...
    // change ball forward movement angle
    if (ball_x > ground_x2 + 20 && ball_x < ground_x2 + 40) {
      speed_x = 0;
      if (speed_y === 4 || speed_y === -4) {
        speed_y = (speed_y * 3) / 2;
      }
    } else if (ball_x < ground_x2 + 20) {
      speed_x = -4;
      if (speed_y === 6 || speed_y === -6) {
        speed_y = (speed_y * 2) / 3;
      }
    } else if (ball_x > ground_x2 + 40) {
      speed_x = 4;
      if (speed_y === 6 || speed_y === -6) {
        speed_y = (speed_y * 2) / 3;
      }
  ...
  /// Wall impact
  // if the ball touch the bottom, score
